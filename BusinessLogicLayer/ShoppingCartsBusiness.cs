...
namespace BusinessLogicLayer
{
    public class ShoppingCartsBusiness
    {
        ...
        public void initShoppingCart(int id)
        {
            ...
            {
                getSetCurrentShoppingCart = shoppingCartsRepository.GetActiveShoppingCart(id); //taking an active shopping cart from a repository
                if (getSetCurrentShoppingCart == null)
                {
                    ShoppingCart shoppingCart = new ShoppingCart(0, id, "Active"); //creating a new shopping cart
