...
namespace BulkOrderCS
{
    public partial class Index : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string isbn = Request.QueryString["isbn"]; //http requests for isbn and quantity
        ...
        private void fillBookCardRow() //books on the index page
        {
            ...
            foreach (Book book in booksBusiness.GetAllBooks()) //adding books with foreach
            {
        ...
        {
            if(ClientsBusiness.getSetCurrentClient == null) //client must be logged in if he wants to buy
            {
